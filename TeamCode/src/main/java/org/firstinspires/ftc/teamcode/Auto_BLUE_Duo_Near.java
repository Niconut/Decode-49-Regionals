...
@Configurable
@Autonomous (name = "BLUE Duo Near", group = "Red Alliance")
public class Auto_BLUE_Duo_Near extends LinearOpMode {
    ...
    private void buildTrajectories(MecanumDrive drive, Pose2d beginPose){
        ...
        TrajectoryActionBuilder trajectoryGateBackUp = trajectoryShootBallsandPickup.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(22, -64, Math.toRadians(-120)), Math.toRadians(90));
        ...
        TrajectoryActionBuilder trajectoryPark = trajectoryFrontPickUp.endTrajectory().fresh()
