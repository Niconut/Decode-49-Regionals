...
@Configurable
@Autonomous (name = "Blue Close Auto", group = "Blue ALliance")
public class Auto_Aim_Auto_Blue extends LinearOpMode {
    ...
    public static double midPickup = -52;
    ...
    public static double frontPickup = -56;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Actions.runBlocking(
                    new SequentialAction(
                            autoSequence(scoringShooter, intakeSubsystem, distanceSensor, scoringGate, shooterSubsystem)
                    )
    ...
    private void buildTrajectories(MecanumDrive drive, Pose2d beginPose){
        ...
        TrajectoryActionBuilder trajectoryGateBackUp = trajectoryShootBallsandPickup.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(18, -64, Math.toRadians(-120)), Math.toRadians(-90));
    ...
    public Action autoSequence(Scoring_Shooter_Action scoringShooter,
