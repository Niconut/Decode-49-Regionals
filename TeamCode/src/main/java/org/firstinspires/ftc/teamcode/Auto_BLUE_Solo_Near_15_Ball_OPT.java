...
@Configurable
@Autonomous (name = "BLUE Solo Near 15 OPT", group = "Blue Alliance")
public class Auto_BLUE_Solo_Near_15_Ball_OPT extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        Pose2d beginPose = new Pose2d(-41, -52, Math.toRadians(-90));
    ...
    private void buildTrajectories(MecanumDrive drive, Pose2d beginPose){
        ...
        TrajectoryActionBuilder trajectoryShootBallsandPickup = drive.actionBuilder(beginPose)
                ...
                .lineToY(-60, new TranslationalVelConstraint(70)) // first pickup

                .splineToConstantHeading(new Vector2d(10,-40), Math.toRadians(90), new TranslationalVelConstraint(70))
                .splineToConstantHeading(new Vector2d(-12, -24), Math.toRadians(-90), new TranslationalVelConstraint(70)); // first score
        ...
        TrajectoryActionBuilder trajectoryGateBackUp = trajectoryShootBallsandPickup.endTrajectory().fresh()
                ...
                .splineToConstantHeading(new Vector2d(7,-52), Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(22, -62, Math.toRadians(-120)), Math.toRadians(90)); // second pickup
        ...
        TrajectoryActionBuilder trajectoryShootBalls3 = trajectoryGateBackUp.endTrajectory().fresh()
                ...
                .splineToConstantHeading(new Vector2d(-12,-22), Math.toRadians(-90), new TranslationalVelConstraint(70)); // 2nd score

        TrajectoryActionBuilder trajectoryFrontPickUp = trajectoryShootBalls3.endTrajectory().fresh()
                .splineToConstantHeading(new Vector2d(-12,-24), Math.toRadians(-90), new TranslationalVelConstraint(70))
                .lineToY(-54, new TranslationalVelConstraint(50)) // 3rd pickup

                .splineToConstantHeading(new Vector2d(-11,-30), Math.toRadians(90), new TranslationalVelConstraint(40))
                .splineToConstantHeading(new Vector2d(-12,-24), Math.toRadians(-90)); // 3rd score

        TrajectoryActionBuilder trajectoryBackPickUp = trajectoryFrontPickUp.endTrajectory().fresh()
                .splineToConstantHeading(new Vector2d(-13,-25), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(36, -32), Math.toRadians(-90))
                .lineToY(-60) // 4th pickup

                .splineToConstantHeading(new Vector2d(26,-46), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(0, -20), Math.toRadians(-180))
                .splineToConstantHeading(new Vector2d(-40, -16), Math.toRadians(180)); // 4th score
