...
@Configurable
@Autonomous (name = "BLUE Duo Far FHT", group = "Blue Alliance")
public class Auto_BLUE_Duo_Far_FHTHTH extends LinearOpMode {
...
//                        new SleepAction(0.05),
                ...
                shooterHood.AutoHood()// enable auto aim for the entire auto
        );
    }
